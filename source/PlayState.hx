			...
			case 'ntfstage':
				{
						...
						var stageFront:FlxSprite = new FlxSprite(-650, 600).loadGraphic(Paths.image('neon/front'));
						stageFront.setGraphicSize(Std.int(stageFront.width * 1.1));
						stageFront.updateHitbox();
						stageFront.antialiasing = true;
			...
			case 'ntfevil':
				{
						...
						var stageFront:FlxSprite = new FlxSprite(-650, 600).loadGraphic(Paths.image('neon/front_evil'));
						stageFront.setGraphicSize(Std.int(stageFront.width * 1.1));
						stageFront.updateHitbox();
						stageFront.antialiasing = true;
						stageFront.scrollFactor.set(1, 1);
			...
			case 'ntfavi':
				{
						...
						var stageFront:FlxSprite = new FlxSprite(-650, 600).loadGraphic(Paths.image('neon/front_avi'));
						stageFront.setGraphicSize(Std.int(stageFront.width * 1.1));
						stageFront.updateHitbox();
						stageFront.antialiasing = true;
						stageFront.scrollFactor.set(1, 1);
